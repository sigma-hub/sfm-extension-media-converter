...
export function formatProgressMessage(info, fileName) {
    const parts = [];
    if (info.time) {
...
export async function convertSingleFile(ffmpegPath, inputPath, ffmpegArgs, progressCallback, cancellationToken) {
